<?php
  ...
  class RtfGroup extends RtfElement
  {
    ...
    public function GetType()
    {
      ...
      if(get_class($child) != "App\Services\RtfControlWord") return null;
      return $child->word;
    }    
    ...
    public function IsDestination()
    {
      ...
      $child = $this->children[0];
      if(get_class($child) != "App\Services\RtfControlSymbol") return null;
      return $child->symbol == '*';
    }
    ...
    public function dump($level = 0)
    {
      ...
      {
        if(get_class($child) == "App\Services\RtfGroup")
        {
  ...
  class RtfHtml
  {
    ...
    protected function FormatGroup($group)
    {
      ...
      {
        if(get_class($child) == "App\Services\RtfGroup") $this->FormatGroup($child);
        if(get_class($child) == "App\Services\RtfControlWord") $this->FormatControlWord($child);
        if(get_class($child) == "App\Services\RtfControlSymbol") $this->FormatControlSymbol($child);
        if(get_class($child) == "App\Services\RtfText") $this->FormatText($child);
      }
