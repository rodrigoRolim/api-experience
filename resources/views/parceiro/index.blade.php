    ...
    <script type="text/javascript">
        $(document).ready(function (){
            ...
            function getItensFiltro(){
                ...
                var dataResultAcomodacao = async.run('{{url("/")}}/parceiro/selectacomodacao',postAcomodacao,'POST');
                ...
                dataResultAcomodacao.then(function(result){
                    ...
                    var dataResultPostoRealizante = async.run('{{url("/")}}/parceiro/selectpostorealizante',postPostoRealizante,'POST');
            ...
            $('#btnFiltrar').click(function(e){
                ...
                var dataResult = async.run('{{url("/")}}/parceiro/filteratendimentos',postData,'POST');
                ...
                dataResult.then(function(result){
                    ...
                    $('#listFilter li').click(function(e){
                        ...
                        $(window.document.location).attr('href',"{{url('/')}}/parceiro/paciente/"+key+"/"+posto+"/"+atendimento);
                    });
