    ...
    <div id="page-wrapper-posto" class="gray-bg">
        ...
        <div class="row-fluid areaPacientePos">
            <div style="padding-left:0px;" class="col-md-6 col-sm-6 col-xs-12">  
                <a href="{{url('')}}/parceiro" class="btn btn-lg btnVoltar pull-left"><i class="fa fa-arrow-left" style="font-size: 24px;"></i></a>      
...
@section('script')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var dataResult = exames.get("{{url('/')}}","parceiro","{{$atendimento->posto}}","{{$atendimento->atendimento}}");
            ...
            dataResult.then(function(result){
                ...
                if(!saldoDevedor){
                    $(".boxExames").click(function(e){
                        ...
                        var dataExameResult = exames.detalheExame("{{url('/')}}","parceiro",posto,atendimento,correl);
