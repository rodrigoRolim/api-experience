        ...
        var r = t("html, body"),
            ...
            s = {
                ...
                shouldLoadAnchor: function(t, n, e) {
                    var o = t.prop("href");
                    return !(s.isExternal(o) || s.isHash(o) || t.is(n) || t.prop("target") || "" !== e && -1 === t.prop("href").search(e))
                },
                ...
                var u = t(i),
                    ...
                    S = function(t, e, o) {
                        ...
                        var h = !1,
                            ...
                            p = {
                                loaded: function() {
                                    ...
                                    f && h ? f && v(i.url) : u.one(t, function() {
                                        v(i.url), o || g(i.url)
                                    }), e && n.history.pushState({
                                        id: c
                                    }, d[i.url].title, i.url), f && !o && g(i.url)
                                },
                                fetching: function() {
                                    h || (h = !0, u.one("ss.onStartEnd", function() {
                        ...
                        d.hasOwnProperty(i.url) || m(i), l.onStart.render(u), n.setTimeout(function() {
                            r.scrollTop(0), u.trigger("ss.onStartEnd")
                        }, l.onStart.duration), p[d[i.url].status]()
                    },
                    w = function(n) {
                        var e, o = t(n.currentTarget);
                        s.shouldLoadAnchor(o, l.blacklist, l.hrefRegex) && !f && (n.stopPropagation(), e = s.translate(o.prop("href")), e = l.alterRequest(e), m(e))
                    },
                    E = function(n) {
                        ...
                        if (!n.metaKey && !n.ctrlKey && s.shouldLoadAnchor(e, l.blacklist, l.hrefRegex) && (n.stopPropagation(), n.preventDefault(), !C())) {
                            ...
                            f = !0, h = e.prop("hash"), o = l.alterRequest(o), l.onBefore(e, u), S(o)
                        }
                    },
                    b = function(n) {
                        var e = t(n.currentTarget);
                        if (!e.is(l.blacklist) && (n.preventDefault(), n.stopPropagation(), !C())) {
                            ...
                            f = !0, r = l.alterRequest(r), "get" === r.type.toLowerCase() && (r.url = r.url + "?" + r.data), l.onBefore(e, u), S(r, o, l.allowFormCaching)
                        }
                    },
                    P = 0,
                    C = function() {
