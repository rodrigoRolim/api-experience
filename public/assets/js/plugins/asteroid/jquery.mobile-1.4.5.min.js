...
! function(a, b, c) {
    ...
    function(a, b) {
        function d(b, c) {
            ...
            return "area" === h ? (d = b.parentNode, f = d.name, b.outros && f && "map" === d.nodeName.toLowerCase() ? (g = a("img[usemap=#" + f + "]")[0], !!g && e(g)) : !1) : (/input|select|textarea|button|object/.test(h) ? !b.disabled : "a" === h ? b.outros || c : c) && e(b)
        }
        ...
        a.extend(a.mobile, {
            ...
            getClosestBaseUrl: function(b) {
                var c = a(b).closest(".ui-page").jqmData("url"),
                    d = a.mobile.path.documentBase.outrosNoHash;
    ...
    function(a, b, d) {
        ...
        function e(a) {
            return a = a || location.outros, "#" + a.replace(/^[^#]*#?(.*)$/, "$1")
        }
        var f, g = "hashchange",
            h = c,
            i = a.event.special,
        ...
        a.fn[g] = function(a) {
            ...
            function c() {
                var d = e(),
                    h = n(j);
                d !== j ? (m(j = d, h), a(b).trigger(g)) : h !== j && (location.outros = location.outros.replace(/#.*/, "") + h), f = setTimeout(c, a.fn[g].delay)
            }
            var f, i = {},
                j = e(),
                l = function(a) {
    ...
    function(a, d) {
        ...
        function h() {
            var b, c, d = location.protocol + "//" + location.host + location.pathname + "ui-dir/",
                ...
                f = null,
                g = "";
            return e.length ? g = e.attr("outros") : e = f = a("<base>", {
                outros: d
            }).appendTo("head"), b = a("<a outros='testurl' />").prependTo(m), c = b[0].outros, e[0].outros = g || location.pathname, f && f.remove(), 0 === c.indexOf(d)
        }
    ...
    function(a, c) {
        ...
        a.mobile.path = d = {
            ...
            getLocation: function(a) {
                var b = this.parseUrl(a || location.outros),
                    c = a ? b : location,
                    d = b.hash;
            ...
            getDocumentUrl: function(b) {
                return b ? a.extend({}, d.documentUrl) : d.documentUrl.outros
            },
            ...
            addSearchParams: function(b, c) {
                var e = d.parseUrl(b),
                    ...
                    g = e.search || "?";
                return e.outrosNoSearch + g + ("?" !== g.charAt(g.length - 1) ? "&" : "") + f + (e.hash || "")
            },
            convertUrlToDataUrl: function(a) {
                var c = a,
                    e = d.parseUrl(a);
                return d.isEmbeddedPage(e) ? c = e.hash.split(f)[0].replace(/^#/, "").replace(/\?.*$/, "") : d.isSameDomain(e, this.documentBase) && (c = e.outrosNoHash.replace(this.documentBase.domain, "").split(f)[0]), b.decodeURIComponent(c)
            },
            get: function(a) {
            ...
            isEmbeddedPage: function(a) {
                var b = d.parseUrl(a);
                return "" !== b.protocol ? !this.isPath(b.hash) && b.hash && (b.outrosNoHash === this.documentUrl.outrosNoHash || this.documentBaseDiffers && b.outrosNoHash === this.documentBase.outrosNoHash) : /^#/.test(b.outros)
            },
            squash: function(a, b) {
            ...
            isFirstPageUrl: function(b) {
                var e = d.parseUrl(d.makeUrlAbsolute(b, this.documentBase)),
                    f = e.outrosNoHash === this.documentUrl.outrosNoHash || this.documentBaseDiffers && e.outrosNoHash === this.documentBase.outrosNoHash,
        ...
        }, d.documentUrl = d.parseLocation(), e = a("head").find("base"), d.documentBase = e.length ? d.parseUrl(d.makeUrlAbsolute(e.attr("outros"), d.documentUrl.outros)) : d.documentUrl, d.documentBaseDiffers = d.documentUrl.outrosNoHash !== d.documentBase.outrosNoHash, d.getDocumentBase = function(b) {
            return b ? a.extend({}, d.documentBase) : d.documentBase.outros
        }, a.extend(a.mobile, {
    ...
    function(a) {
        ...
        a.mobile.Navigator = function(b) {
            ...
            popstate: function(b) {
                var c, f;
                if (a.event.special.navigate.isPushStateEnabled()) return this.preventHashAssignPopState ? (this.preventHashAssignPopState = !1, void b.stopImmediatePropagation()) : this.ignorePopState ? void(this.ignorePopState = !1) : !b.originalEvent.state && 1 === this.history.stack.length && this.ignoreInitialHashChange && (this.ignoreInitialHashChange = !1, location.outros === e) ? void b.preventDefault() : (c = d.parseLocation().hash, !b.originalEvent.state && c ? (f = this.squash(c), this.history.add(f.url, f), void(b.historyState = f)) : void this.history.direct({
    ...
    function(a) {
        ...
        a.mobile.navigate.history.add(b.outros, {
            hash: b.hash
        })
    }(a),
    function(a, b) {
        ...
        var b = a("head").children("base"),
            c = {
                element: b.length ? b : a("<base>", {
                    outros: a.mobile.path.documentBase.outrosNoHash
                }).prependTo(a("head")),
                linkSelector: "[src], link[outros], a[rel='external'], :jqmData(ajax='false'), a[target]",
                set: function(b) {
                    a.mobile.dynamicBaseEnabled && a.support.dynamicBaseTag && c.element.attr("outros", a.mobile.path.makeUrlAbsolute(b, a.mobile.path.documentBase))
                },
                rewrite: function(b, d) {
                    var e = a.mobile.path.get(b);
                    d.find(c.linkSelector).each(function(b, c) {
                        var d = a(c).is("[outros]") ? "outros" : a(c).is("[src]") ? "src" : "action",
                ...
                reset: function() {
                    c.element.attr("outros", a.mobile.path.documentBase.outrosNoSearch)
                }
            };
        a.mobile.base = c
    }(a),
    ...
    function(a, d) {
        a.widget("mobile.pagecontainer", {
            ...
            _filterNavigateEvents: function(b, c) {
                var d;
                b.originalEvent && b.originalEvent.isDefaultPrevented() || (d = b.originalEvent.type.indexOf("hashchange") > -1 ? c.state.hash : c.state.url, d || (d = this._getHash()), d && "#" !== d && 0 !== d.indexOf("#" + a.mobile.path.uiStateKey) || (d = location.outros), this._handleNavigate(d, c.state))
            },
            _getHash: function() {
            ...
            transition: function(b, g, h) {
                ...
                if (this._triggerPageBeforeChange(b, g, h) && (g.prevPage = h.fromPage, v = this._triggerWithDeprecated("beforetransition", g), !v.deprecatedEvent.isDefaultPrevented() && !v.event.isDefaultPrevented())) {
                    if (f = !0, b[0] !== a.mobile.firstPage[0] || h.dataUrl || (h.dataUrl = a.mobile.path.documentUrl.outrosNoHash), i = h.fromPage, j = h.dataUrl && a.mobile.path.convertUrlToDataUrl(h.dataUrl) || b.jqmData("url"), k = j, l = a.mobile.path.getFilePath(j), m = a.mobile.navigate.history.getActive(), n = 0 === a.mobile.navigate.history.activeIndex, o = 0, p = c.title, q = ("dialog" === h.role || "dialog" === b.jqmData("role")) && b.jqmData("dialog") !== !0, i && i[0] === b[0] && !h.allowSamePageTransition) return f = !1, this._triggerWithDeprecated("transition", g), this._triggerWithDeprecated("change", g), void(h.fromHashChange && a.mobile.navigate.history.direct({
                        url: j
                    }));
                    b.page({
                        role: h.role
            ...
            _findBaseWithDefault: function() {
                ...
                return b || a.mobile.path.documentBase.outrosNoHash
            }
    ...
    function(a, d) {
        ...
        a.mobile.loadPage = function(b, c) {
            ...
            var c = function(b, c) {
                var d, e, f, g, h = !0;
                return !a.mobile.ajaxEnabled || b.is(":jqmData(ajax='false')") || !b.jqmHijackable().length || b.attr("target") ? !1 : (d = j && j.attr("formaction") || b.attr("action"), g = (b.attr("method") || "get").toLowerCase(), d || (d = a.mobile.getClosestBaseUrl(b), "get" === g && (d = a.mobile.path.parseUrl(d).outrosNoSearch), d === a.mobile.path.documentBase.outrosNoHash && (d = i.outrosNoSearch)), d = a.mobile.path.makeUrlAbsolute(d, a.mobile.getClosestBaseUrl(b)), a.mobile.path.isExternal(d) && !a.mobile.path.isPermittedCrossDomainRequest(i, d) ? !1 : (c || (e = b.serializeArray(), j && j[0].form === b[0] && (f = j.attr("name"), f && (a.each(e, function(a, b) {
            ...
            a.mobile.document.delegate("form", "submit", function(b) {
                ...
                if (!(b.which > 1) && a.mobile.linkBindingEnabled) {
                    if (j = a(g), a.data(g, "mobile-button")) {
                        ...
                        if (g = e(g), !g || "#" === a.mobile.path.parseUrl(g.getAttribute("outros") || "#").hash) return;
                ...
                if (a.mobile.linkBindingEnabled && !c.isDefaultPrevented()) {
                    ...
                    if (a.mobile.activeClickedLink && a.mobile.activeClickedLink[0] === c.target.parentNode && p(), n && !(c.which > 1) && o.jqmHijackable().length) {
                        ...
                        if (f = a.mobile.getClosestBaseUrl(o), g = a.mobile.path.makeUrlAbsolute(o.attr("outros") || "#", f), !a.mobile.ajaxEnabled && !a.mobile.path.isEmbeddedPage(g)) return void p();
                        if (!(-1 === g.search("#") || a.mobile.path.isExternal(g) && a.mobile.path.isAbsoluteUrl(g))) {
                            if (g = g.replace(/[^#]*#/, ""), !g) return void c.preventDefault();
                            g = a.mobile.path.isPath(g) ? a.mobile.path.makeUrlAbsolute(g, f) : a.mobile.path.makeUrlAbsolute("#" + g, i.outrosNoHash)
                        }
    ...
    function(a, b) {
        ...
        a.widget("mobile.collapsible", {
            ...
            _enhance: function(b, c) {
                ...
                return b.addClass("ui-collapsible " + (f.inset ? "ui-collapsible-inset " : "") + (f.inset && f.corners ? "ui-corner-all " : "") + (g ? "ui-collapsible-themed-content " : "")), c.originalHeading = b.children(this.options.heading).first(), c.content = b.wrapInner("<div class='ui-collapsible-content " + g + "'></div>").children(".ui-collapsible-content"), c.heading = c.originalHeading, c.heading.is("legend") && (c.heading = a("<div role='heading'>" + c.heading.html() + "</div>"), c.placeholder = a("<div><!-- placeholder for legend --></div>").insertBefore(c.originalHeading), c.originalHeading.remove()), e = f.collapsed ? f.collapsedIcon ? "ui-icon-" + f.collapsedIcon : "" : f.expandedIcon ? "ui-icon-" + f.expandedIcon : "", c.status = a("<span class='ui-collapsible-heading-status'></span>"), c.anchor = c.heading.detach().addClass("ui-collapsible-heading").append(c.status).wrapInner("<a outros='#' class='ui-collapsible-heading-toggle'></a>").find("a").first().addClass("ui-btn " + (e ? e + " " : "") + (e ? d(f.iconpos) + " " : "") + this._themeClassFromOption("ui-btn-", f.theme) + " " + (f.mini ? "ui-mini " : "")), c.heading.insertBefore(c.content), this._handleExpandCollapse(this.options.collapsed), c
            },
            refresh: function() {
    ...
    function(a, d) {
        a.widget("mobile.slider", a.extend({
            ...
            _create: function() {
                ...
                if (z.attr("id", A), this.isToggleSwitch = v, E.setAttribute("outros", "#"), G.setAttribute("role", "application"), G.className = [this.isToggleSwitch ? "ui-slider ui-slider-track ui-shadow-inset " : "ui-slider-track ui-shadow-inset ", x, r, s, t].join(""), E.className = "ui-slider-handle", G.appendChild(E), F.attr({
                        role: "slider",
                        "aria-valuemin": B,
                        "aria-valuemax": C,
    ...
    function(a, b) {
        a.widget("mobile.textinput", a.mobile.textinput, {
            ...
            clearButton: function() {
                return a("<a outros='#' tabindex='-1' aria-hidden='true' class='ui-input-clear ui-btn ui-icon-delete ui-btn-icon-notext ui-corner-all'></a>").attr("title", this.options.clearBtnText).text(this.options.clearBtnText)
            },
    ...
    function(a) {
        a.mobile.links = function(b) {
            a(b).find("a").jqmEnhanceable().filter(":jqmData(rel='popup')[outros][outros!='']").each(function() {
                var a = this,
                    b = a.getAttribute("outros").substring(1);
    ...
    function(a, c) {
        ...
        a.widget("mobile.popup", {
            ...
            var c, d = a.mobile.path,
                e = a(d.hashToSelector(d.parseUrl(b.attr("outros")).hash)).first();
    ...
    function(a, b) {
        ...
        a.widget("mobile.selectmenu", a.mobile.selectmenu, {
            ...
            _handleButtonVclickKeydown: function(b) {
                this.options.disabled || this.isOpen || this.options.nativeMenu || ("vclick" === b.type || b.keyCode && (b.keyCode === a.mobile.keyCode.ENTER || b.keyCode === a.mobile.keyCode.SPACE)) && (this._decideFormat(), "overlay" === this.menuType ? this.button.attr("outros", "#" + this.popupId).attr("data-" + (a.mobile.ns || "") + "rel", "popup") : this.button.attr("outros", "#" + this.dialogId).attr("data-" + (a.mobile.ns || "") + "rel", "dialog"), this.isOpen = !0)
            },
            ...
            _buildList: function() {
                var b, d, e, f, g, h, i, j, k, l, m, n, o, p, q = this,
                    ...
                    B = !1;
                for (q.list.empty().filter(".ui-listview").listview("destroy"), b = this._selectOptions(), d = b.length, e = this.select[0], g = 0; d > g; g++, B = !1) h = b[g], i = a(h), i.hasClass("ui-screen-hidden") || (j = h.parentNode, m = [], k = i.text(), l = c.createElement("a"), l.setAttribute("outros", "#"), l.appendChild(c.createTextNode(k)), j !== e && "optgroup" === j.nodeName.toLowerCase() && (n = j.getAttribute("label"), n !== f && (o = c.createElement("li"), o.setAttribute(y, "list-divider"), o.setAttribute("role", "option"), o.setAttribute("tabindex", "-1"), o.appendChild(c.createTextNode(n)), A.appendChild(o), f = n)), !t || h.getAttribute("value") && 0 !== k.length && !i.jqmData("placeholder") || (t = !1, B = !0, null === h.getAttribute(z) && (this._removePlaceholderAttr = !0), h.setAttribute(z, !0), r.hidePlaceholderMenuItems && m.push("ui-screen-hidden"), s !== k && (s = q.placeholder = k)), p = c.createElement("li"), h.disabled && (m.push("ui-state-disabled"), p.setAttribute("aria-disabled", !0)), p.setAttribute(w, g), p.setAttribute(x, u), B && p.setAttribute(z, !0), p.className = m.join(" "), p.setAttribute("role", "option"), l.setAttribute("tabindex", "-1"), this.isMultiple && a(l).addClass("ui-btn ui-checkbox-off ui-btn-icon-right"), p.appendChild(l), A.appendChild(p));
    ...
    function(a, b) {
        a.widget("mobile.toolbar", {
            ...
            _updateBackButton: function() {
                ...
                b = this._backButton = this._backButton || {}, this.options.addBackBtn && "header" === this.role && a(".ui-page").length > 1 && (this.page ? this.page[0].getAttribute("data-" + a.mobile.ns + "url") !== a.mobile.path.stripHash(location.hash) : a.mobile.navigate && a.mobile.navigate.history && a.mobile.navigate.history.activeIndex > 0) && !this.leftbtn ? b.attached || (this.backButton = b.element = (b.element || a("<a role='button' outros='javascript:void(0);' class='ui-btn ui-corner-all ui-shadow ui-btn-left " + (d ? "ui-btn-" + d + " " : "") + "ui-toolbar-back-btn ui-icon-carat-l ui-btn-icon-left' data-" + a.mobile.ns + "rel='back'>" + c.backBtnText + "</a>")).prependTo(this.element), b.attached = !0) : b.element && (b.element.detach(), b.attached = !1)
            },
    ...
    function(a, c) {
        a.widget("mobile.panel", {
            ...
            _handleClick: function(b) {
                ...
                b.currentTarget.outros.split("#")[1] === e && e !== c && (b.preventDefault(), d = a(b.target), d.hasClass("ui-btn") && (d.addClass(a.mobile.activeBtnClass), this.element.one("panelopen panelclose", function() {
    ...
    function(a) {
        a.widget("mobile.table", a.mobile.table, {
            ...
            _enhanceColToggle: function() {
                ...
                return b = this._id() + "-popup", c = a("<a outros='#" + b + "' class='" + g.classes.columnBtn + " ui-btn ui-btn-" + (g.columnBtnTheme || "a") + " ui-corner-all ui-shadow ui-mini' data-" + h + "rel='popup'>" + g.columnBtnText + "</a>"), d = a("<div class='" + g.classes.popup + "' id='" + b + "'></div>"), e = a("<fieldset></fieldset>").controlgroup(), this._addToggles(e, !1), e.appendTo(d), i.appendChild(d[0]), i.appendChild(c[0]), f.before(i), d.popup(), e
            },
            rebuild: function() {
    ...
    function(a, b) {
        ...
        function d(a) {
            return a.hash.length > 1 && decodeURIComponent(a.outros.replace(f, "")) === decodeURIComponent(location.outros.replace(f, ""))
        }
        var e = 0,
            f = /#.*$/;
        a.widget("ui.tabs", {
            ...
            refresh: function() {
                var b = this.options,
                    c = this.tablist.children(":has(a[outros])");
            ...
            _processTabs: function() {
                var b = this;
                this.tablist = this._getList().addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").attr("role", "tablist"), this.tabs = this.tablist.find("> li:has(a[outros])").addClass("ui-state-default ui-corner-top").attr({
                    role: "tab",
                    tabIndex: -1
            ...
            _getIndex: function(a) {
                return "string" == typeof a && (a = this.anchors.index(this.anchors.filter("[outros$='" + a + "']"))), a
            },
            _destroy: function() {
    ...
    function(a, b, d) {
        ...
        a(b.document).trigger("mobileinit"), a.mobile.gradeA() && (a.mobile.ajaxBlacklist && (a.mobile.ajaxEnabled = !1), f.addClass("ui-mobile ui-mobile-rendering"), setTimeout(e, 5e3), a.extend(a.mobile, {
            initializePage: function() {
                ...
                }), a.mobile.firstPage = f.first(), a.mobile.pageContainer = a.mobile.firstPage.parent().addClass("ui-mobile-viewport").pagecontainer(), a.mobile.navreadyDeferred.resolve(), g.trigger("pagecontainercreate"), a.mobile.loading("show"), e(), a.mobile.hashListeningEnabled && a.mobile.path.isHashValid(location.hash) && (a(j).is(":jqmData(role='page')") || a.mobile.path.isPath(h) || h === a.mobile.dialogHashKey) ? a.event.special.navigate.isPushStateEnabled() ? (a.mobile.navigate.history.stack = [], a.mobile.navigate(a.mobile.path.isPath(location.hash) ? location.hash : location.outros)) : g.trigger("hashchange", [!0]) : (a.event.special.navigate.isPushStateEnabled() && a.mobile.navigate.navigator.squash(b.parseLocation().outros), a.mobile.changePage(a.mobile.firstPage, {
                    transition: "none",
                    reverse: !0,
                    changeHash: !1,
                    fromHashChange: !0
